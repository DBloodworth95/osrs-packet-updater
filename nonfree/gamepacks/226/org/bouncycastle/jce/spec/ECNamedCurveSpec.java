...
public class ECNamedCurveSpec extends java.security.spec.ECParameterSpec {
   ...
   static java.security.spec.ECPoint convertPoint(ECPoint var0) {
      var0 = var0.normalize();
      return new java.security.spec.ECPoint(var0.getAffineXCoord().toBigInteger(), var0.getAffineYCoord().toBigInteger());
   }
