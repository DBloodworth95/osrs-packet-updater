 ...
 * 8. Once found, find the first int on that line, that is out offset multiplier.
 */
public class OffsetMultiplier implements PatternSearcher {
    private String offsetMultiplier = "Unknown";
    ...
    public boolean matches(File file, String content, SearchContext context) {
        ...
        try {
            ...
            if (extendedClass != null) {
                offsetMultiplier = findOffsetMultiplier(extendedClass, file.getParent());
                return !offsetMultiplier.equals("Unknown");
            }
    ...
    private String findOffsetMultiplier(String extendedClassName, String path) {
        try {
            Launcher fieldLauncher = new Launcher();
